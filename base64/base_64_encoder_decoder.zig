...
// all attributions go to these excellent resources
// zig's platform indepencence and shedding libc to be independent is so exciting for systems programming

// written by Dinabandhu Khatiwada
// github.com/dinabandhuk
...
pub fn main() !void {
    ...
    const text = "Testing Base64 Encoder decoder in zig";
    const etext = "VGVzdGluZyBCYXNlNjQgRW5jb2RlciBkZWNvZGVyIGluIHppZw==";
